...
// TODO: DESIGN: bring back expTime. for each thread keep a possible evict list that consist of items this thread inserted and their expTimes, check the list before popping tail.
